    ...
    <header>
      <ul class="nav nav-pills">
        <li class="nav-item active">
          <a class="nav-link" href="deleteform.php">DASH4</a>
        </li>
        <li class="nav-item">
      ...
      <div class="main-content-header">
        ...
        <table class="table1">
            ...
            <tr>
            <th>Student Class</th>
            <td><input type="text" name="class" class="class"/></td>
            <th>Student Rollno</th>
            <td><input type="text" name="rollno" class="class"/></td>
         ...
         <table class="table2">
              <tr> 
                ...
                <th class="student_class">Section</th>
         ...
         <?php
            ...
            <th class="student_class2"> <?php  echo $data['u_section'].'<br>'; ?></th> 
